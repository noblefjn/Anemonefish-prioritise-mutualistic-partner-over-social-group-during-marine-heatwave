...
##Data Prep ####
data<-read.csv("Article_Dataset.csv", header =  TRUE)
...
Mainplot <- Mainplot +
  labs(tag = "A: Maintenance") +
  theme(plot.tag = element_text(face = "bold", size = 14))

Defplot <- Defplot +
  labs(tag = "B: Defensive") +
  theme(plot.tag = element_text(face = "bold", size = 14))

Aggplot <- Aggplot +
  labs(tag = "C: Aggressive") +
  theme(plot.tag = element_text(face = "bold", size = 14))
...
Mainplot <- Mainplot + legend_theme
Defplot  <- Defplot  + legend_theme
Aggplot  <- Aggplot  + legend_theme
Neuplot  <- Neuplot  + legend_theme
Subplot  <- Subplot  + legend_theme

combined_plot <- (Mainplot / Defplot /
